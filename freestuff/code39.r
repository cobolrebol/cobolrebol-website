...
;;  --  Convert a text string into a VID image by making
;;  --  one-pixel-wide black boxes of a user-configurable height.
...
barcode: func [
	...
	if not height [height: 40]	;Default is 40
	if not name [name: %code39.png]
	code39: [
		"1" "110100101011"
		"2" "101100101011"
		"3" "110110010101"
...
;;  --  Barcodes require a start and stop character.
	convfrom: rejoin ["*" data "*"]

;;  --  Programmatically build a VID layout of black boxes, 
