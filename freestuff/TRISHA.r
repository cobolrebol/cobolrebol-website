...
;; [                                                                           ]
;; [ Bug note:  For reasons unknown at this time, if the presentation file     ]
;; [ has only one page, the program will return an error when opening the      ]
;; [ file.  The workaround is to have several pages, or to put a blank         ]
;; [ page, that is, a line like this...                                        ]
;; [ []                                                                        ]
...
MAIN-WINDOW: [
    banner "Tiny Rebol Information SHow Assistant" font [size: 24 shadow: none]
