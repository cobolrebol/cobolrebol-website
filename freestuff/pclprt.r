...
PCLPRT-INSTALLATION-NAME: "C I T Y    O F    B L O O M I N G T O N"
PCLPRT-SERVER: %/cob-print02/
PCLPRT-DEFAULT-PRINTER: "FILE"
PCLPRT-FILE-ID: %printfile.txt
PCLPRT-PRINTER-LIST: [
    FILE
    ASSESSING01
    ASSESSING02
...
PCLPRT-RESET:            "^(esc)E"
PCLPRT-FORMFEED:         "^(page)"
PCLPRT-LANDSCAPE:        "^(esc)&l1O"
PCLPRT-FONT-LINEPRINTER: "^(esc)(10U^(esc)(s0p16.67h8.5v0s0b0T"
PCLPRT-MARGIN-LEFT-5:    "^(esc)&a5L"
PCLPRT-MARGIN-TOP-4:     "^(esc)&l4E"
PCLPRT-LPI-8:            "^(esc)&l8D"
...
PCLPRT-CLOSE: does [
    append PCLPRT-FILE PCLPRT-RESET
    either equal? "FILE" to-string PCLPRT-PRINTER  [
        write/binary PCLPRT-FILE-ID PCLPRT-FILE
    ] [
...
;; [ classic COBOL manner.  The print headings automatically, checks for       ]
...
PCLPRT-LP-TITLE: copy PCLPRT-INSTALLATION-NAME 
PCLPRT-LP-HEADING-1: ""
PCLPRT-LP-HEADING-2: ""
PCLPRT-LP-USER-HEADING-1: ""
PCLPRT-LP-USER-HEADING-2: ""
